    ...
    io.github.xiaotong6666.fusehide.ui.theme.fuseHideTheme {
        FuseHideHomeScreen(
            ...
            configState = ConfigUiState(
                ...
                lastAckResultText = "-",
                lastApplyTimeText = "-",
                draftVsAppliedDiff = HideConfigDiff(false, "None", ""),
                appliedConfigSnapshotText = "",
                highlightConfigResults = false,
                configResultsScrollToken = 0,
                enableHideAllRootEntries = true,
                hideAllRootEntriesExemptionsText = "",
                hiddenTargetsText = "",
                hiddenPackagesText = "",
            ),
            debugState = DebugUiState(pathText = "/sdcard", pathText2 = "", outputText = ""),
            configCallbacks = ConfigCallbacks(
                {}, {}, {}, {}, {}, {}, {}, {}, {},
            ),
            debugCallbacks = DebugCallbacks(
